...
class NikuInputDecoration with ContentPaddingMacro, FloatingLabelBehaviorMacro {
  ...
  set apply(NikuInputDecoration? v) {
    ...
    helperStyle?.apply = v.helperStyle;
    helperMaxLines ??= v.helperMaxLines;
    hintText ??= v.hintText;
    hintStyle?.apply = v.hintStyle;
    hintTextDirection ??= v.hintTextDirection;
    hintMaxLines ??= v.hintMaxLines;
    errorText ??= v.errorText;
    errorStyle?.apply = v.errorStyle;
    errorMaxLines ??= v.errorMaxLines;
    floatingLabelBehavior ??= v.floatingLabelBehavior;
    isDense ??= v.isDense;
    contentPadding?.apply = v.contentPadding;
    isCollapsed ??= v.isCollapsed;
    prefixIcon ??= v.prefixIcon;
    prefixIconConstraints?.apply = v.prefixIconConstraints;
    prefix ??= v.prefix;
    ...
    focusedErrorBorder ??= v.focusedErrorBorder;
    disabledBorder ??= v.disabledBorder;
    enabledBorder ??= v.enabledBorder;
    border ??= v.border;
    enabled ??= v.enabled;
    semanticCounterText ??= v.semanticCounterText;
    alignLabelWithHint ??= v.alignLabelWithHint;
    constraints?.apply = v.constraints;
  }
