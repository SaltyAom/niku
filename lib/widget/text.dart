...
class NikuText {
  ...
  NikuText apply(NikuText instance) => this.set(
        ...
        fontSize: instance._fontSize,
        fontWeight: instance._fontWeight,
        letterSpacing: instance._letterSpacing,
        wordSpacing: instance._wordSpacing,
        height: instance._height,
        foreground: instance._foreground,
        background: instance._background,
        shadows: instance._shadows,
        fontFeatures: instance._fontFeatures,
        textDecoration: instance._textDecoration,
        textDecorationColor: instance._textDecorationColor,
        textDecorationThickness: instance._textDecorationThickness,
        fontFamily: instance._fontFamily,
        fontFamilyFallback: instance._fontFamilyFallback,
        textBaseline: instance._textBaseline,
        textDirection: instance._textDirection,
        textAlign: instance._textAlign,
        locale: instance._locale,
        softWrap: instance._softWrap,
        overflow: instance._overflow,
        textScaleFactor: instance._textScaleFactor,
        maxLines: instance._maxLines,
        semanticsLabel: instance._semanticsLabel,
        textWidthBasis: instance._textWidthBasis,
        textHeightBehavior: instance._textHeightBehavior,
      );
